    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_food_selected_today', models.ManyToManyField(related_name='inventory', through='core.PostFood', to='core.Food')),
                ('food_selected', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.food')),
                ('person_of', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
